...
import com.huhu.model.user.BUserModel;
...
//		`R_Des` text,
	...
	public MerModel getMerModeld() {
		return merModeld;
	}
	public void setMerModeld(MerModel merModeld) {
		this.merModeld = merModeld;
	}
